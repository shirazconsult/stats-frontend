...
public class Stats implements EntryPoint {
	private static final Logger logger = Logger.getLogger("StatsEntryPoint");
...
//		 see GWT Issue 1617: UncaughtExceptionHandler not triggered for exceptions occurring in onModuleLoad() [http://code.google.com/p/google-web-toolkit/issues/detail?id=1617]
		GWT.setUncaughtExceptionHandler(new GWT.UncaughtExceptionHandler() {
			...
			public void onUncaughtException(Throwable e) {
				...
				logger.log(Level.SEVERE, "Failed to startup Stats entry point.", e);
			}
		});

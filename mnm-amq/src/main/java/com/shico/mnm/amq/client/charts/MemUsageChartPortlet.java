...
public class MemUsageChartPortlet extends LineChartPortlet {	
	public MemUsageChartPortlet(AmqChartDataProvider dataProvider, double widthRatio, double heightRatio) {

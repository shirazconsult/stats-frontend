...
public class NonHeapMemChartPanel extends LineChartPanel {

	public NonHeapMemChartPanel(AggregatorChartDataProvider dataProvider, double widthRatio, double heightRatio) {
	...
	protected LineChartPopup asPopupPanel() {
		chartPopup = new LineChartPopup(new NonHeapMemChartPanel((AggregatorChartDataProvider)dataProvider, widthRatio, heightRatio));
		return chartPopup;
	}	
